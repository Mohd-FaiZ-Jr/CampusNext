            ...
            <div className="min-h-screen bg-gray-50 pt-20 pb-12">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100">
                        ...
                        <div className="relative h-96 bg-gradient-to-br from-blue-100 to-indigo-50 flex items-center justify-center group">
                            <span className="text-9xl transform group-hover:scale-110 transition-transform duration-500">
                                🏠
                            </span>
                            {property.verified && (
                                <div className="absolute top-6 right-6 bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg">
                                ...
                                <div className="flex-1 space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-zinc-600 text-lg">
                                            ...
                                            {property.distance ? `${property.distance} km from campus` : "Near campus"}
                                        </div>
                                    </div>
