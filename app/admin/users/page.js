    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-4 sm:mb-6">
        <input
          ...
          className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 font-poppins"
        />
      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="shrink-0 h-10 w-10 mr-4">
                          {user.profileImage ? (
                            ...
                            <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-900 font-bold border border-gray-200 font-montserrat">
